...
var adjustShove15 = function adjustShove15(context) {
  saveShoveAmount(context, "15");
};

var adjustShove48 = function adjustShove48(context) {
  saveShoveAmount(context, "48");
};

var adjustShove64 = function adjustShove64(context) {
  saveShoveAmount(context, "64");
};

var adjustShove128 = function adjustShove128(context) {
  saveShoveAmount(context, "128");
};

saveShoveAmount = function saveShoveAmount(context, amount) {// mainThreadDict[kShoveAmount] = amount;
